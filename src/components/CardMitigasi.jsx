        ...
        <CRow xs={{ cols: 1, gutter: 4 }} md={{ cols: 2 }}>
            <CCol xs>
                <div className="flex flex-column border rounded-md p-3 hover:bg-gradient-to-tl hover:from-gray-200 hover:to-white-500 h-full">
                    ...
                    <footer className="text-slate-400 text-md pb-3">- Source <a href="//bnpb.go.id/definisi-bencana" className="hover:text-sky-400 cursor-pointer italic">bnpb.go.id/definisi-bencana</a></footer>
                    <div className="text-center flex-auto flex justify-content-center align-items-end">
                        <a href="//bnpb.go.id/definisi-bencana" className="hover:text-white"><Button Button="Read more" /></a>
                    </div>
                </div>
            </CCol>
            <CCol xs>
                <div className="flex flex-column border rounded-md p-3 hover:bg-gradient-to-tl hover:from-gray-200 hover:to-white-500 h-full">
                    ...
                    <footer className="text-slate-400 text-md pb-3">- Source <a href="//id.wikipedia.org/wiki/Tsunami" className="hover:text-sky-400 cursor-pointer italic">id.wikipedia.org/wiki/Tsunami</a></footer>
                    <div className="text-center flex-auto flex justify-content-center align-items-end">
